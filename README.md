...
📝 **Note 2**: The code requires **MATLAB version at least 2024a** to ensure the [deep.DifferentiableFunction](https://www.mathworks.com/help/deeplearning/ug/define-custom-deep-learning-operations.html) class exist.
...
<!-- TOC --><a name="news"></a>
## News
- **2025/10/07:**  :bookmark: The manuscript is now online at [here](https://opg.optica.org/optica/fulltext.cfm?uri=optica-12-10-1615&id=581947) <br>
