...
__global__ void hashEncoding_Fwd_kernel(
    ...
    output_embedding[batch_offset + level_id * feature_dim + 0] = feature1;
    output_embedding[batch_offset + level_id * feature_dim + 1] = feature2;
}
...
__global__ void hashEncoding_Bwd_kernel(
    ...
    float dl_output1 = dl_doutput[batch_offset + 0];16
